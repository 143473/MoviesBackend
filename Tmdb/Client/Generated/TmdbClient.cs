...
namespace tmdb_api
{
    ...
    public partial interface IMoviesClient
    {
        ...
        System.Threading.Tasks.Task<MoviesListResponse> GetListOfMoviesAsync(int movie_id, string api_key, string language = null, int? page = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MoviesClient : IMoviesClient
    {
        ...
        /// <returns>Returns list of movies</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<MoviesListResponse> GetListOfMoviesAsync(int movie_id, string api_key, string language = null, int? page = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (movie_id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MoviesListResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
